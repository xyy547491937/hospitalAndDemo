    ...
    <div class="btm" v-show="!videofullScreen">
      ...
      <div class="box comment">
        ...
        <div class="comment-list">
          ...
          <div class="comment-item" v-for="(item,index) in commenList" :key="index" v-if="index<2">
            <div class="item-img">
              <!-- <img src="http://fs.meiduduo.com/shop/SHOP/other/1530167832624.jpg" alt=""> -->
            ...
            >
              ...
              <div class="author">
                <div class="author-box">
                  ...
                  <span class="nicknamer">{{item.authorName}}</span>
                </div>
...
export default {
      ...
      this.$http
        ...
        .then(res => {
          ...
          if (res.code == "1") {
            ...
            this.$store.commit('backauthorChange',{id:author,status:state})
          }
        });
    },
    // 获取评论列表
  ...
  onUnload() {
    ...
    console.log(this.commentTotal,this.videoInfo.isFollow&&!this.isSelf,this.videoInfo.fabulousNum)
