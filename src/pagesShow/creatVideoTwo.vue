...
<style scoped>
  ...
  .video-align-box, .input-align-box {
  ...
  <div style="padding-bottom:40rpx;">
    ...
    <div class="qu-body">
      <div class="align-box">
        ...
        <div class="img-box video-img-box">
          <!-- <div class="imglist">
      ...
      <div class="align-box video-align-box">
        <!-- <div class="align">
          <span class="circle"></span>
          <span class="title" style="margin-right: 14rpx;margin-left: 0;">内容</span>
        </div> -->
        <textarea
          class="input input-content textarea-box"
          style="height:200rpx"
          maxlength="50"
          id
          v-model="content"
          placeholder="想要和大家分享点什么..."
        ></textarea>
        <span class="input-aside textarea-aside">{{textAreaNumber}}/50</span>
      </div>
      <div class="align-box input-align-box">
        <!-- <div class="align">
          <span class="circle"></span>
        ...
        <input
          ...
          placeholder="请输入标题"
        >
        <span class="input-aside input-box-aside">{{inputNumber}}/20</span>
      </div>
      <div class="align-box">
        <div class="align">
          <!-- <span class="circle"></span> -->
          ...
          <span class="tip1" v-if="imgList.length"></span>
        </div>
        <div class="img-box">
          <div
            class="img-item-box"
    ...
    <div v-if="uploadSuccess" class="progress-mask" @touchmove.stop="">
      <span>正在上传中（{{progressNumber}}%）......</span>
    </div>
  </div>
</template>
      ...
      wx.chooseVideo({
        ...
        success(res) {
          ...
          uploadTask.onProgressUpdate(res => {
            that.progressNumber = res.progress
            if (res.progress == 100) {
              that.uploadSuccess = false
            }
