...
<template>
    <div class="wx-content-info">
                ...
                >
                    ...
                    >
                        <div class="wx-cropper-div-box">
                            ...
                            <div
                                class="wx-cropper-line-t"
                                data-drag="top"
                                @touchstart.stop="dragStart"
                                @touchmove.stop="dragMove"
                            ></div>
                            <div
                                class="wx-cropper-line-r"
                                data-drag="right"
                                @touchstart.stop="dragStart"
                                @touchmove.stop="dragMove"
                            ></div>
                            <div
                                class="wx-cropper-line-b"
                                data-drag="bottom"
                                @touchstart.stop="dragStart"
                                @touchmove.stop="dragMove"
                            ></div>
                            <div
                                class="wx-cropper-line-l"
                                data-drag="left"
                                @touchstart.stop="dragStart"
                                @touchmove.stop="dragMove"
                            ></div>
                            <div
                                class="wx-cropper-point point-t"
                                data-drag="top"
                                @touchstart.stop="dragStart"
                                @touchmove.stop="dragMove"
                            ></div>
                            ...
                            <div
                                class="wx-cropper-point point-r"
                                data-drag="right"
                                @touchstart.stop="dragStart"
                                @touchmove.stop="dragMove"
                            ></div>
                            <div
                                class="wx-cropper-point point-rb"
                                data-drag="rightBottom"
                                @touchstart.stop="dragStart"
                                @touchmove.stop="dragMove"
                            ></div>
                            <div
                                class="wx-cropper-point point-b"
                                data-drag="bottom"
                                @touchstart.stop="dragStart"
                                @touchmove.stop="dragMove"
                            ...
                            <div
                                class="wx-cropper-point point-l"
                                data-drag="left"
                                @touchstart.stop="dragStart"
                                @touchmove.stop="dragMove"
                            ></div>
        ...
        <div class="cropper-config">
            ...
            <button type="primary" @click="getImageInfo" style="margin-top: 30rpx;">点击生成图片</button>
        </div>
        <canvas
            canvas-id="myCanvas"
            style="position:absolute;border: 1px solid red;top:-9999px;left:-9999px;"
            :style="{width:qualityWidth+'px',height:qualityWidth/innerAspectRadio+'px'}"
        ></canvas>
    </div>
</template>
    ...
    methods: {
        ...
        loadImage: function() {
            ...
            wx.getImageInfo({
                ...
                success: function success(res) {
                    ...
                    let minRange =
                        IMG_REAL_W > IMG_REAL_H ? IMG_REAL_W : IMG_REAL_H;
                    INIT_DRAG_POSITION =
                        minRange > INIT_DRAG_POSITION
                            ? INIT_DRAG_POSITION
                            : minRange;
                    ...
                    if (IMG_RATIO >= 1) {
                        ...
                        _this.cutL = Math.ceil(
                            (SCREEN_WIDTH - SCREEN_WIDTH + INIT_DRAG_POSITION) /
                                2
                        );
                        ...
                        _this.cutR = Math.ceil(
                            (SCREEN_WIDTH - SCREEN_WIDTH + INIT_DRAG_POSITION) /
                                2
                        );
                        _this.cutB = Math.ceil(
                            (SCREEN_WIDTH / IMG_RATIO -
                                (SCREEN_WIDTH / IMG_RATIO -
                                    INIT_DRAG_POSITION)) /
                                2
                        ...
                        _this.cutT = Math.ceil(
                            (SCREEN_WIDTH - INIT_DRAG_POSITION) / 2
                        );
                        _this.cutB = Math.ceil(
                            (SCREEN_WIDTH - INIT_DRAG_POSITION) / 2
                        );
        ...
        getImageInfo() {
            ...
            ctx.draw(true, () => {
                ...
                var canvasW =
                    ((_this.cropperW - _this.cutL - _this.cutR) /
                        _this.cropperW) *
                    IMG_REAL_W;
                var canvasH =
                    ((_this.cropperH - _this.cutT - _this.cutB) /
                        _this.cropperH) *
                    IMG_REAL_H;
                    ...
                    success: function(res) {
                        ...
                        wx.uploadFile({
                          ...
                          success(res) {
                            ...
                            //   _this.imgListUrls.push(data.data);
